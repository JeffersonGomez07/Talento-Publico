...
const llenar_campos = async () => {
  ...
  if (empleado) {
    ...
    txtApellido1.value = empleado.apellido1;
    txtApellido2.value = empleado.apellido2;
    txtCorreo.value = empleado.correo;
  }
};
...
function enviar_datos() {
  ...
  if (error_campos_vacios) {
    ...
    modificar_empleado(_id, Nombre, Apellido1, Apellido2, Correo);

    mostrar_alerta_exitosa("Haz actualizado tú cuenta correctamente!");
    limpiar_datos();
  }
}
