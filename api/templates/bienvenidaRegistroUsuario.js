    ...
    <tr>
      <td style="padding: 20px;">
        ...
        <p style="color: #fff; text-align: center;">
          ...
          Te damos la bienvenida a la aplicación Talento Público.
        </p>
        <p style="color: #fff; text-align: center;">Con Talento Público, podrás explorar una amplia variedad de empleos en diferentes industrias y niveles. Ya sea que estés buscando tu primer trabajo o quieras dar un paso adelante en tu trayectoria, nuestra plataforma te conectará con distintos tipos de oportunidades.</p>
        <p style="color: #fff; text-align: center;">¡Empieza a explorar y da el primer paso hacia un futuro laboral brillante!</p>
